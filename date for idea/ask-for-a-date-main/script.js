document.addEventListener("DOMContentLoaded", function () {
    ...
    title.textContent = '';
    // Coding By 420demeter - ig: @bombohz
...
// const heartInterval = 30; // Her 3 pikselde bir kalp oluştur
// const numberOfHearts = 1000; // Oluşturulacak kalp sayısı
...
const heartColors = ['#ff5e5e', '#ffb6b6', '#ff8484', '#ff9292', '#ffaaaa']; // Renkli kalp renkleri
const heartInterval = 15; // Her 3 pikselde bir kalp oluştur
const numberOfHearts = 5000; // Oluşturulacak kalp sayısı
...
yesButton.addEventListener('click', function () {
    ...
    const title = document.querySelector('.title');
    title.textContent = 'sende aşıksın itiraf et :)';
});
// Coding By Coder - 420demeter - ig: @bombohz
function generateHearts() {
    const symbols = ['❤️', '💖', '💗', '💕', '💓', '💖', '💗', '💕', '💓', '💖', '💗', '💕', '💓'];
    const heartInterval = 1000;
